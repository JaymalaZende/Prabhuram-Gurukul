...
function HeroSection() {
  return (
    ...
    >
      <form action="/action_page.php" className="container max-w-sm mx-auto p-8 bg-gray-100 rounded-lg shadow-lg mr-10" data-aos="fade-up">
        <h1 className="text-3xl font-serif font-bold mb-6">ADMISSION ENQUIRY FOR THE SESSION 2024-25</h1>
        ...
        <input type="email" placeholder="Enter Email" name="email" required className="w-full px-4 py-2 mb-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" pattern="[a-zA-Z0-9._%+-]+@acd\.in" />
        <input type="tel" placeholder="Enter Parent Mobile Number" name="Parentmobile" required className="w-full px-4 py-2 mb-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" pattern="[0-9]{10}" />
        <select name="class" required className="w-full px-4 py-2 mb-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">
